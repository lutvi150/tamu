...
if($passwordbaru2 !="")
{
	if($passwordbaru != $ulangipassword)
	{
		...
		<section class="content">
		  <div class="callout callout-info">
			...
			Klik
			<a href="?page=profile">Disini Untuk Melihat Profile</a>
		  </div>
		</section>
		<?php
	}
	...
	{
		mysqli_query($koneksi,"update user set nama='$namalengkap', password='$passwordbaru', telepon_user='$telepon', email_user='$email' where kode_user='$iduser'");
...
{
mysqli_query($koneksi,"update user set nama='$namalengkap', telepon_user='$telepon', email_user='$email' where kode_user='$iduser'");
$ip=$_SERVER['REMOTE_ADDR'];
date_default_timezone_set('Asia/Jakarta');
...
if($namafoto !="")
{	
$cekuser=mysqli_query($koneksi,"select * from user where kode_user='$iduser'");
