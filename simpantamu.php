...
{
include "koneksi.php";
mysqli_query($koneksi,"INSERT INTO tamu ( id_tamu, uid, nama, jenis_id, nik, alamat, instansi,jenis_kelamin, id_user, tgl_update,no_hp ) VALUES ( null, '$uid', '$nama', '$jenisidentitas', '$identitas', '$alamat', '$instansi','$kelamin','$iduser','$today','$no_hp' )");
$data="INSERT INTO tamu ( id_tamu, uid, nama, nik, alamat, instansi,jenis_kelamin, id_user, tgl_update,no_hp ) VALUES ( null, '$uid', '$nama', '$identitas', '$alamat', '$instansi','$kelamin','$iduser','$today','$no_hp' )";

}
else 
{
	include "koneksi.php";
	mysqli_query($koneksi,"UPDATE tamu set nama = '$nama', jenis_id='$jenisidentitas', nik = '$identitas', alamat = '$alamat', instansi = '$instansi', jenis_kelamin = '$kelamin', id_user='$iduser', tgl_update='$today', no_hp='$no_hp' WHERE uid = '$uid'");
