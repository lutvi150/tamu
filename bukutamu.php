          ...
          <div class="row">
				  ...
				  <div class="form-group">
					...
					<form action="" method="post">
                      ...
                      <input type="text" class="form-control" id="uid" name="uid2"  autofocus placeholder="Letakan Kartu diatas reader. Jika tidak terdeteksi, silahkan input manual no id kartu kemudian enter"> <br>
            ...
            <form class="form-horizontal" action="?page=simpantamu" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="uid" id="inputEmail3" value="<?php echo $idkartu ?>"  required >
                  </div>
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="identitas" id="inputEmail3" value="<?php echo $datatamu['nik'] ?>" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" id="inputEmail3" value="<?php echo $datatamu['nama'] ?>" required >
                  </div>
                </div>
                  <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="no_hp" id="inputEmail3" value="<?php echo $datatamu['no_hp'] ?>" required >
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="alamat" value="<?php echo $datatamu['alamat'] ?>"  required>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="instansi" value="<?php echo $datatamu['instansi'] ?>" required>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control" name="kelamin" required>
				    <option value="<?php echo $datatamu['jenis_kelamin'] ?>"><?php echo $datatamu['jenis_kelamin'] ?></option>
