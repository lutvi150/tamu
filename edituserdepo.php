...
$sqluser2=mysqli_query($koneksi,"select * from user as us left join tenant as tn on us.kode_tenant=tn.kode_tenant left join depo as dp on us.kode_depo=dp.kode_depo  where us.kode_user='$kodeuser'");
	...
	<section class="content">
      ...
      <div class="box box-default">
		...
		<div class="box-body">
          <div class="row">
		  <br>
				<form class="form-horizontal" action="?page=updateuserdepo" method="POST"  enctype="multipart/form-data">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-9">
					  <select class="form-control select2" style="width: 100%;" name="jenisuser2">
					  
						<option value="<?php echo $datauser2['jenis_user'] ?>"><?php echo $datauser2['jenis_user'] ?></option>
						<?php
