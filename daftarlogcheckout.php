...
<div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Daftar Log Tamu Check-Out</h3>
				...
				<table width="100%" class="table table-striped table-bordered table-hover" id="example1">
					...
					<tbody>
						...
						<tr class="odd gradeX">
						    ...
						    <td align="center"><a href="#" class="edit-record-elog" data-idlog="<?php echo $datalog['no_log'] ?>"><?php echo $no ?></a></td>
							...
							<td><a href="?page=checkout&idlog=<?php echo $datalog['no_log'] ?>"onclick="return confirm('Anda Yakin Akan Check-Out Tamu Ini ... ?')"><button type="button" class="btn btn-danger pull-left btn-xs"><i class="fa fa-power-off"></i> Check-Out</button></a></td>
							<?php
							}
							else
							{
