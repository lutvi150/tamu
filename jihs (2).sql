...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2019 at 12:32 PM
...
INSERT INTO `aktifitas_kampus` (`id_aktifitas`, `judul_aktifitas`, `deskripsi_aktifitas`, `tgl_aktifitas`, `foto_aktifitas`) VALUES
(1, 'TABLE MANNER SMK 38', '<p>learn how to be great table manner with JIHS&nbsp;</p>\r\n', '2019-05-08 00:00:00', '1.png'),
(2, 'Seminar Peluang dan Tantangan Lulusan Perhotelan Di Era Mendatang', '<p>Pada tanggal &nbsp;3 Maret 2014 diadakan seminar yang berjudul Peluang dan Tantangan Lulusan Perhotelan Di Era Mendatang. Acara ini bertempat Aula Akademi Pariwisata Jakarta International Hotels yang terletak di kawasan SCBD Sudirman. Sebagai nara sumber utama adalah Prof.DR.JB.Sumarlin mantan pejabat Mentri Ekonomi dan Keuangan pada masa orde baru. Selain dihadiri oleh para mahasiswa seminar ini juga dihadiri oleh beberapa pejabat teras di lingkungan Kementrian Ekonomi Kreatif dan para pejabat Direksi di lingkungan PT.JIHD Tbk. Para mahasiswa begitu antusias dalam mendengarkan wejangan dari mantan mentri ini, dan beberapa mahasiswa tampak bersemangat mengajukan beberapa pertanyaan. Bapak JB. Sumarlin berpesan kepada seluruh mahasiswa untuk Terus Bekerja Keras dan Belajar dalam menghadapi tantangan di masa mendatang.</p>\r\n', '2014-11-10 00:00:00', '2.JPG');
...
CREATE TABLE `calon_mahasiswa` (
  `id_calonmahasiswa` int(11) NOT NULL,
  ...
  `status_tempattinggal` varchar(100) DEFAULT NULL,
  `nama_ayah` varchar(100) DEFAULT NULL,
  `keadaan_ayah` varchar(100) DEFAULT NULL,
  `tempat_lahir_ayah` varchar(100) DEFAULT NULL,
  `tanggal_lahir_ayah` date DEFAULT NULL,
  `nama_ibu` varchar(200) DEFAULT NULL,
  `keadaan_ibu` varchar(100) DEFAULT NULL,
  `tempat_lahir_ibu` varchar(100) DEFAULT NULL,
  `tanggal_lahir_ibu` date DEFAULT NULL,
  `alamat_wali` text,
  `kota_wali` varchar(100) DEFAULT NULL,
  `kodepos_wali` varchar(6) DEFAULT NULL,
  `telepon_wali` varchar(15) DEFAULT NULL,
  `handphone_wali` varchar(15) DEFAULT NULL,
  `pendidikan_ayah` varchar(20) DEFAULT NULL,
  `pendidikan_ibu` varchar(20) DEFAULT NULL,
  `pekerjaan_ayah` varchar(50) DEFAULT NULL,
  `pekerjaan_ibu` varchar(50) DEFAULT NULL,
  `penghasilan_wali` varchar(12) DEFAULT NULL,
  `nama_sd` varchar(100) DEFAULT NULL,
  `alamat_sd` text,
  `kota_sd` varchar(100) DEFAULT NULL,
  `tahun_lulus_sd` varchar(4) DEFAULT NULL,
  `nama_sltp` varchar(100) DEFAULT NULL,
  `alamat_sltp` text,
  `kota_sltp` varchar(100) DEFAULT NULL,
  `tahun_lulus_sltp` varchar(4) DEFAULT NULL,
  `nama_slta` varchar(100) DEFAULT NULL,
  `alamat_slta` text,
  `kota_slta` varchar(100) DEFAULT NULL,
  `provinsi_slta` varchar(100) DEFAULT NULL,
  `jurusan_slta` varchar(100) DEFAULT NULL,
  `tanggal_ijazah` varchar(2) DEFAULT NULL,
  `bulan_ijazah` varchar(2) DEFAULT NULL,
  `tahun_ijazah` varchar(4) DEFAULT NULL,
  `no_ijazah` varchar(25) DEFAULT NULL,
  `nem` varchar(10) DEFAULT NULL,
  `nilai_sttb` varchar(10) DEFAULT NULL,
  `nama_lembaga1` varchar(100) DEFAULT NULL,
  `jenis_ketrampilan1` varchar(100) DEFAULT NULL,
  `alamat_lembaga1` text,
  `kota_lembaga1` varchar(100) DEFAULT NULL,
  `tahun_lembaga1` varchar(4) DEFAULT NULL,
  `nama_lembaga2` varbinary(100) DEFAULT NULL,
  `jenis_ketrampilan2` varchar(100) DEFAULT NULL,
  `alamat_lembaga2` text,
  `kota_lembaga2` varchar(100) DEFAULT NULL,
  `tahun_lembaga2` varchar(4) DEFAULT NULL,
  `beasiswa` varchar(100) DEFAULT NULL,
  `pemberi_beasiswa` varchar(100) DEFAULT NULL,
  `bentuk_beasiswa` varchar(50) DEFAULT NULL,
  `jumlah_beasiswa` varchar(20) DEFAULT NULL,
  `waktu_beasiswa` varchar(4) DEFAULT NULL,
  `kunjungan_perpustakaan` varchar(25) DEFAULT NULL,
  `membaca` varchar(25) DEFAULT NULL,
  `seminar` varchar(25) DEFAULT NULL,
  `olahraga` varchar(25) DEFAULT NULL,
  `kesenian` varchar(25) DEFAULT NULL,
  `kerja_sosial` varchar(25) DEFAULT NULL,
  `bahasa_daerah1` varchar(50) DEFAULT NULL,
  `aktif_daerah1` varchar(25) DEFAULT NULL,
  `bahasa_daerah2` varchar(50) DEFAULT NULL,
  `aktif_daerah2` varchar(25) DEFAULT NULL,
  `bahasa_daerah3` varchar(50) DEFAULT NULL,
  `aktif_daerah3` varchar(25) DEFAULT NULL,
  `bahasa_asing1` varchar(50) DEFAULT NULL,
  `aktif_asing1` varchar(25) DEFAULT NULL,
  `bahasa_asing2` varchar(50) DEFAULT NULL,
  `aktif_asing2` varchar(25) DEFAULT NULL,
  `bahasa_asing3` varchar(50) DEFAULT NULL,
  `aktif_asing3` varchar(25) DEFAULT NULL,
  `nama_perusahaan` varchar(100) DEFAULT NULL,
  `bagian_perusahaan` varchar(100) DEFAULT NULL,
  `jabatan_perusahaan` varchar(100) DEFAULT NULL,
  `alamat_perusahaan` text,
  `kota_perusahaan` varchar(100) DEFAULT NULL,
  `kodepos_perusahaan` varchar(6) DEFAULT NULL,
  `telepon_perusahaan` varchar(15) DEFAULT NULL,
  `lama_bekerja` varchar(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `calon_mahasiswa` (`id_calonmahasiswa`, `nama_lengkap`, `tempat_lahir`, `tanggal_lahir`, `alamat`, `kota`, `kodepos`, `telepon`, `handphone`, `kelamin`, `agama`, `kewarganegaraan`, `negara`, `status_perkawinan`, `golongan_darah`, `status_tempattinggal`, `nama_ayah`, `keadaan_ayah`, `tempat_lahir_ayah`, `tanggal_lahir_ayah`, `nama_ibu`, `keadaan_ibu`, `tempat_lahir_ibu`, `tanggal_lahir_ibu`, `alamat_wali`, `kota_wali`, `kodepos_wali`, `telepon_wali`, `handphone_wali`, `pendidikan_ayah`, `pendidikan_ibu`, `pekerjaan_ayah`, `pekerjaan_ibu`, `penghasilan_wali`, `nama_sd`, `alamat_sd`, `kota_sd`, `tahun_lulus_sd`, `nama_sltp`, `alamat_sltp`, `kota_sltp`, `tahun_lulus_sltp`, `nama_slta`, `alamat_slta`, `kota_slta`, `provinsi_slta`, `jurusan_slta`, `tanggal_ijazah`, `bulan_ijazah`, `tahun_ijazah`, `no_ijazah`, `nem`, `nilai_sttb`, `nama_lembaga1`, `jenis_ketrampilan1`, `alamat_lembaga1`, `kota_lembaga1`, `tahun_lembaga1`, `nama_lembaga2`, `jenis_ketrampilan2`, `alamat_lembaga2`, `kota_lembaga2`, `tahun_lembaga2`, `beasiswa`, `pemberi_beasiswa`, `bentuk_beasiswa`, `jumlah_beasiswa`, `waktu_beasiswa`, `kunjungan_perpustakaan`, `membaca`, `seminar`, `olahraga`, `kesenian`, `kerja_sosial`, `bahasa_daerah1`, `aktif_daerah1`, `bahasa_daerah2`, `aktif_daerah2`, `bahasa_daerah3`, `aktif_daerah3`, `bahasa_asing1`, `aktif_asing1`, `bahasa_asing2`, `aktif_asing2`, `bahasa_asing3`, `aktif_asing3`, `nama_perusahaan`, `bagian_perusahaan`, `jabatan_perusahaan`, `alamat_perusahaan`, `kota_perusahaan`, `kodepos_perusahaan`, `telepon_perusahaan`, `lama_bekerja`) VALUES
(1, 'Ahmad Nursahid', '', '1993-06-06', 'Jl Universitas Indonesia', 'Jakarta Selatan', '12710', '085291836550', '085291836550', 'Pria', 'Islam', 'WNI', 'Indonesia', 'Belum Kawin', 'A', 'Kost', 'Akhmad Sujari', 'Masih Hidup', 'Kebumen', '0000-00-00', 'Sodirah', 'Masih Hidup', 'Kebumen', '1970-01-01', 'Jakarta Selatan', 'Jakarta Selatan', '54352', '0219029288', '0928929272', 'Tamat SD', 'Tamat SD', 'Pegawai Negri', 'Pegawai Negri', 'Kurang dari ', 'SDN 01 Seliling', 'Seliling', 'Kebumen', '2005', 'SMP N5 Kebumen', 'Kebumen', 'Kebumen', '2008', 'SMK TKM KBM', 'Kebumen', 'Kebumen', 'Jawa Tengah', 'Otomotif', '01', '06', '2011', 'DN-00120812', '8.98', '9.00', 'Komputer', 'Komputer', 'Kebumen', 'Kebumen', '2011', 0x424c4b204b55, 'BLK', 'Kebumen', 'Kebumen', '2012', 'Prestasi', 'BRI', 'Cash', '9000000', '2012', 'Aktif', 'Cukup', 'Kurang', 'Kurang', 'Cukup', 'Aktif', 'Jawa', 'Aktif', 'Medan', 'Cukup', 'Sunda', 'Cukup', 'Inggeris', 'Aktif', 'Perancis', 'Cukup', 'Jerman', 'Aktif', 'PT  SLS', 'IT', 'IT', 'Jakarta', 'Jakarta', '54352', '0218939723', '5'),
(2, 'Ahmad Nursahid', 'Kebumen', '1993-06-06', 'Jl Universitas Indonesia', 'Jakarta Selatan', '12710', '085291836550', '085291836550', 'Pria', 'Islam', 'WNI', 'Indonesia', 'Belum Kawin', 'A', 'Kost', 'Akhmad Sujari', 'Masih Hidup', 'Kebumen', '1960-01-01', 'Sodirah', 'Masih Hidup', 'Kebumen', '1970-01-01', 'Jakarta Selatan', 'Jakarta Selatan', '54352', '0219029288', '0928929272', 'Tamat SD', 'Tamat SD', 'Pegawai Negri', 'Pegawai Negri', 'Kurang dari ', 'SDN 01 Seliling', 'Seliling', 'Kebumen', '2005', 'SMP N5 Kebumen', 'Kebumen', 'Kebumen', '2008', 'SMK TKM KBM', 'Kebumen', 'Kebumen', 'Jawa Tengah', 'Otomotif', '01', '06', '2011', 'DN-00120812', '8.98', '9.00', 'Komputer', 'Komputer', 'Kebumen', 'Kebumen', '2011', 0x424c4b204b55, 'BLK', 'Kebumen', 'Kebumen', '2012', 'Prestasi', 'BRI', 'Cash', '9000000', '2012', 'Aktif', 'Cukup', 'Kurang', 'Kurang', 'Cukup', 'Aktif', 'Jawa', 'Aktif', 'Medan', 'Cukup', 'Sunda', 'Cukup', 'Inggeris', 'Aktif', 'Perancis', 'Cukup', 'Jerman', 'Aktif', 'PT  SLS', 'IT', 'IT', 'Jakarta', 'Jakarta', '54352', '0218939723', '5');
...
INSERT INTO `foto` (`id_foto`, `judul_foto`, `kategori_foto`, `foto`) VALUES
(1, 'Kegitan', '2', '1.jpg');
...
INSERT INTO `kampus_event` (`id_event`, `judul_event`, `deskripsi_event`, `tgl_event`, `foto_event`) VALUES
(1, 'Seminar', '<p>Pada tanggal &nbsp;3 Maret 2014 diadakan seminar yang berjudul Peluang dan Tantangan Lulusan Perhotelan Di Era Mendatang. Acara ini bertempat Aula Akademi Pariwisata Jakarta International Hotels yang terletak di kawasan SCBD Sudirman. Sebagai nara sumber utama adalah Prof.DR.JB.Sumarlin mantan pejabat Mentri Ekonomi dan Keuangan pada masa orde baru. Selain dihadiri oleh para mahasiswa seminar ini juga dihadiri oleh beberapa pejabat teras di lingkungan Kementrian Ekonomi Kreatif dan para pejabat Direksi di lingkungan PT.JIHD Tbk. Para mahasiswa begitu antusias dalam mendengarkan wejangan dari mantan mentri ini, dan beberapa mahasiswa tampak bersemangat mengajukan beberapa pertanyaan. Bapak JB. Sumarlin berpesan kepada seluruh mahasiswa untuk Terus Bekerja Keras dan Belajar dalam menghadapi tantangan di masa mendatang.</p>\r\n', '2019-05-01 00:00:00', '1.JPG');
...
INSERT INTO `kategori_foto` (`id_kategori`, `nama_kategori`) VALUES
(1, 'Kampus'),
(2, 'Kegiatan Kampus'),
(3, 'Practice Day'),
(4, 'Wisuda XII');
...
CREATE TABLE `konten` (
  ...
  `nama_konten` varchar(250) DEFAULT NULL,
...
INSERT INTO `profile` (`nama_kampus`, `email_kampus`, `alamat_kampus`, `telepon_kampus`, `fax_kampus`, `twitter`, `facebook`, `linkind`, `peta`, `logo`, `alamat_web`, `nama_web`, `deskripsi_web`, `youtube`) VALUES
('Jakarta International Hotel School', 'jihakpar@yahoo.com', 'Jl. Jend Sudirman Kav 52-53 Lot 21, Jakarta Selatan 12190', '+62 21-5736332', '+62 21-5736311', 'https://twitter.com/akpar_jih', 'https://www.facebook.com/pages/Jakarta-International-Hotels-School/714410078641320', 'http://linkedin.com/maxenstudio', 'peta.jpg', 'logo.png', 'http://jihs.ac.id/', 'Jakarta International Hotels School - Akademi Pariwisata Jakarta', '<p>Jakarta International Hotels School of Hospitality merupakan satu-satunya akademi yang menggunakan metode Praktek Manajerial selama 3 tahun untuk membentuk karakater Hotelier &amp; Hospitality yang professional.</p>\r\n', '');
...
(1, 'Hotel Operation', '<p>Program Diploma I Hotel Operation mencetak para lulusan terampil &nbsp;siap kerja dalam waktu singkat. Metode belajar dengan rasio 30 % teori dan 70 % praktek dan interenship di hotel berbintang 5 selama 6 bulan. Program ini membantu mahasiswa untuk meningkatkan hotel skill anda di beberapa departemen yang ada di hotel. Mahasiswa akan menguasai ketrampilan dasar di Housekeeping, Front Office , Food Beverage Service dan Culinary. Para lulusan program ini akan disalurkan mendapatkan pekerjaan baik di dalam maupun luar negeri bagi yang memenuhi kriteria. &nbsp;</p>\r\n', '1.jpg', 'Diploma I'),
(2, 'Hotel Public Relations', '<p>Tujuan Pendidikan</p>\r\n\r\n<p>Program studi D3 Komunikasi Peminatan Kehumasan (Public Relations) bertujuan untuk:</p>\r\n\r\n<p>1. Menghasilkan tenaga ahli madya bidang kehumasan yang kompeten, disiplin, dan berkepribadian</p>\r\n\r\n<p>2. Menghasilkan lulusan yang berkualitas sesuai dengan kebutuhan tenaga kehumasan hotel, pemerintahan, perusahaan, dan organisasi-organisasi lainnya.</p>\r\n\r\n<p>3. Menyiapkan lulusan yang dapat melanjutkan pendidikan ke jenjang pendidikan lanjut dalam bidang komunikasi dan/atau kehumasan.</p>\r\n\r\n<p>Profile Lulusan : Public relations Manager</p>\r\n\r\n<p>Waktu Study : 6 Semester (3-5 tahun) | Beban Study : 110-120 SKS | Sebutan yang diberikam : Ahli Madya Pariwisata (A.md, Par)</p>\r\n\r\n<p>D. Kompetensi Lulusan</p>\r\n\r\n<p>Program studi D3 Komunikasi Peminatan Kehumasan (Public Relations) diarahkan pada usaha untuk menghasilkan lulusan yang memiliki kompetensi sebagai berikut:</p>\r\n\r\n<p>1. kompetensi personal, yakni:</p>\r\n\r\n<p>a. Memiliki integritas moral dan etika yang baik</p>\r\n\r\n<p>b. Memiliki kepribadian yang mantap</p>\r\n\r\n<p>2. kompetensi akademik (keilmuan)</p>\r\n\r\n<p>a. Menguasai ilmu bidang pokok, yakni ilmu komunikasi (komunikasi antar pribadi, komunikasi organisasi, maupun komunikasi massa)</p>\r\n\r\n<p>b. Menguasai ketrampilan di bidang kehumasan dengan baik. Kompetensi Profesional</p>\r\n\r\n<p>c. Memiliki integritas pribadi dan profesi</p>\r\n\r\n<p>d. Memiliki perilaku yang baik terhadap klien</p>\r\n\r\n<p>e. Memiliki perilaku yang baik terhadap public dan media</p>\r\n\r\n<p>f. Memiliki perilaku yang baik terhadap rekan se-profesi</p>\r\n\r\n<p>g. Memiliki kemampuan dasar mengenai hubungan masyarakat</p>\r\n\r\n<p>h. Memiliki kemampuan untuk berbicara dan negosiasi sebagai<br />\r\nhumas hotel atau perusahaan</p>\r\n\r\n<p>i. Memiliki kemampuan untuk penulisan naskah kehumasan</p>\r\n\r\n<p>j. Memiliki kemampuan penggunaan media kehumasan</p>\r\n\r\n<p>k. Memberi kemampuan mengatasi masalah dan penyusunan strategi kehumasan</p>\r\n\r\n<p>L. Memiliki kemampuan presentasi dan menyusun strategi presentasi</p>\r\n\r\n<p>3. kompetensi sosial</p>\r\n\r\n<p>a. Mampu melakukan hubungan sosial yang baik dengan lingkungan sosialnya dalam rangka pelaksanaan dan pengembangan profesinya.</p>\r\n\r\n<p>b. Memiliki manajemen yang baik dalam rangka pelaksanaan tugas-tugasnya.</p>\r\n\r\n<p>&nbsp;</p>\r\n', '2.jpg', 'Diploma III'),
(3, 'Food & Beverage Service', '<p>Tujuan Pendidikan : untuk menghasilkan lulusan yang memiliki kompetensi dalam mensupervisi usaha pada bagian penyajian makan dan minuman<br />\r\nProfil Lulusan : Restaurant Supervisor / Head Waiter dan Bartender<br />\r\nWaktu Studi : 6 Semester (3-5 tahun) | Beban Studi : 110-120 SKS | Sebutan yang diberikan : Ahli Madya Pariwisata (A.Mad.Par).</p>\r\n\r\n<p>Visi</p>\r\n\r\n<p>Menjadi program studi unggulan menghasilkan tenaga professional di bidang Tata Hidangan, memliki keunggulan kompetitif dalam memenuhi standar internasional.</p>\r\n\r\n<p>Misi</p>\r\n\r\n<p>Menyelenggarakan program pendidikan yang dapat menghasilkan tenaga professional di bidang Tata Hidangan, bermutu andal dan berorientasi pada pemenuhan kebutuhan dunia usaha/industri baik nasional maupun internasional, menciptakan iklim yang kondusif melalui potensi yang dimiliki untuk memberikan pelayanan prima, menghasilkan lulusan yang memiliki kompetensi sesuai bidangnya agar mampu berkompetisi di era global.</p>\r\n\r\n<p>Tujuan Pendidikan</p>\r\n\r\n<p>Menghasilkan lulusan/tenaga kerja yang professional di bidang Tata Hidangan.</p>\r\n\r\n<p>Kompetensi Lulusan</p>\r\n\r\n<p>Kompetensi Utama<br />\r\nMengembangkan kepribadian yang luhur serta jiwa nasionalisme.<br />\r\nMenerapkan nilai-nilai sikap dan etika profesi.<br />\r\nPengetahuan dan kemampuan di bidang Perhotelan seperti: Tata Hidangan Makanan dan Minuman, Manajemen Hotel serta Bahasa Inggris Profesi. dalam pengembangan serta penerapannya.<br />\r\nSikap dan prilaku seorang insan pariwisata yang profesional; memiliki etos kerja serta disiplin yang tinggi.<br />\r\nWawasan dan ketajaman visi akan perkembangan ilmu pengetahuan dan teknologi, khususnya di bidang Perhotelan dan Restoran; seperti teknologi informasi dan komputerisasi yang menunjang berbagai aktivitas dalam industri perhotelan dan Restoran.<br />\r\nKemampuan berpikir kritis dan melakukan problem solving.<br />\r\nKemampuan untuk berkomunikasi dan beradaptasi.<br />\r\nKepekaan terhadap aspek ekonomi, bisnis dan kehidupan bermasyarakat.<br />\r\nPengembangan karakter, spiritualitas dan kepemimpinan.&nbsp;<br />\r\nKompetensi Pendukung lulusan:<br />\r\nBerkomunikasi dalam bahasa Inggris dan Bahasa Asing lainnya seperti: Bahasa Mandarin, Bahasa Jepang dan Bahasa Perancis.<br />\r\nKompetensi dalam menggunakan teknologi informasi yang tercanggih.<br />\r\nKompetensi dalam menyelenggarakan dan mengatur persiapan acara, baik skala besar maupun skala kecil; terutama yang terkait dengan bidang MICE.<br />\r\nKompetensi Lainnya/Pilihan Lulusan&nbsp;&nbsp;<br />\r\nKompetensi untuk menjadi pendidik dalam bidang ilmu perhotelan dan pariwisata.<br />\r\nKompetensi untuk melakukan penelitian dalam bidang ilmu dan teknologi yang terkait dengan bidang pariwisata, khususnya Manajemen Perhotelan.<br />\r\nKompetensi di bidang wirausaha / entrepreneur; khususnya kemampuan berwirausaha dalam mengelola bisnis yang terkait dengan perhotelan maupun usaha jasa lainnya.</p>\r\n', '3.JPG', 'Diploma III'),
(4, 'Rooms Division', '<p>Tujuan Pendidikan : untuk menghasilkan lulusan yang memiliki kompetensi dalam mensupervisi operasional pada bagian Kantor Depan &amp; Divisi Kamar.<br />\r\nProfil Lulusan : Front Office Manager &amp; Executive Housekeeper<br />\r\nWaktu Studi : 6 Semester (3-5 tahun) | Beban Studi : 110-120 SKS | Sebutan yang diberikan : Ahli Madya Pariwisata (A.md, Par).</p>\r\n\r\n<p>Kompetensi<br />\r\nMenangani pemesanan kamar, kedatangan dan keberangkatan tamu.<br />\r\nMenangani informasi, surat menyurat, pesanan dan barang tamu<br />\r\nMenangani pelayanan telepon, faksimili, surat dan internet<br />\r\nMenangani pembayaran rekening tamu<br />\r\nMerencanakan dan menyelenggarakan MICE</p>\r\n\r\n<p>Menangani check in dan check out untuk tamu VIP</p>\r\n\r\n<p>Menangani Complaint dari tamu<br />\r\nMenangani administrasi operasional Divisi Kamar<br />\r\nMampu menyiapkan kamar dan membersihkan ruang hotel lainnya</p>\r\n\r\n<p>Mampu menyiapkan kamar ready to sell (Vacant Clean Inspected)</p>\r\n\r\n<p>Mampu menbuat standard set up untuk hotel khususnya kamar</p>\r\n\r\n<p>Mampu membuat Room Cost untuk hotel bintang 5 (Lima)<br />\r\nMenangani pelayanan &quot;butler&quot;Menyiapkan mainpower untuk operasional</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n', '4.jpg', 'Diploma III'),
(5, 'Chef Academy', '<p>Tujuan Pendidikan :&nbsp; untuk menghasilkan lulusan yang memiliki kompetensi dalam mensupervisi usaha pada bagian pengolahan makanan.<br />\r\nProfil Lulusan : Chef de Party / Food Supervisor<br />\r\nWaktu Studi : 6 Semester (3-5 tahun) | Beban Studi : 110-120 SKS | Sebutan yang diberikan : Ahli Madya Pariwisata (A.Mad.Par).</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>VISI</strong></p>\r\n\r\n<p><br />\r\nMenjadi lembaga pendidikan tinggi di bidang tata boga yang bercirikan pemenuhan kebutuhan masyarakat dan memiliki keunggulan kompetitif dalam memenuhi standar internasional guna merebut peluang kerja serta mampu menciptakan lapangan kerja sendiri.</p>\r\n\r\n<p>&nbsp;<br />\r\n<strong>MISI</strong></p>\r\n\r\n<p><br />\r\nMenyelenggarakan program pendidikan yang bermutu andal dan berorientasi pada pemenuhan kebutuhan dunia usaha/ industri, lokal, nasional dan internasional, sehingga lulusan siap memasuki dunia kerja.<br />\r\nMenciptakan iklim yang kondusif dengan memberdayakan semua potensi yang dimiliki guna memberikan&nbsp; pelayanan prima kepada pengguna melalui program pendidikan yang berkualitas.<br />\r\nMenghasilkan lulusan yang memiliki kompetensi di bidang ilmu pengetahuan, teknologi dan seni, sehingga mampu berkompetisi di era pasar bebas.<br />\r\n&nbsp;<br />\r\n&nbsp;</p>\r\n\r\n<p><strong>KOMPETENSI LULUSAN</strong></p>\r\n\r\n<p><br />\r\nLulusan&nbsp;&nbsp; Program&nbsp;&nbsp; Studi&nbsp;&nbsp; Pendidikan&nbsp;&nbsp; Tata&nbsp;&nbsp; Boga&nbsp;&nbsp; mempunyai kompetensi sebagai berikut:</p>\r\n\r\n<p>Membuat, mengembangkan dan menciptakan makanan serta mengaplikasikannya kedalam berbagai bentuk penyajian makanan<br />\r\nMenerapkan prinsip-prinsip pengawasan pada bidang produksi makanan&nbsp;<br />\r\nMenciptakan gagasan-gagasan Inovatif<br />\r\nMengaplikasikan metode investasi di bidang pengolahan makanan<br />\r\nMenyusun anggaran oprasional dalam bidang pengolahan makanan<br />\r\nMenerapkan prinsip-prinsip penentuan harga jual makanan dan minuman<br />\r\nMenerapkan prinsip-prinsip manajemen sumber daya manusia dalam bidang pengolahan makanan<br />\r\nMenerapkan prinsip-prinsip pemasaran dalam penjualan makanan dan minuman</p>\r\n\r\n<p><br />\r\n<strong>Kepribadian</strong></p>\r\n\r\n<p>Menjadi manusia Indonesia seutuhnya yang beriman dan bertaqwa kepada Tuhan Yang Maha Esa, berakhlak mulia, berkepribadian mantap, stabil, dewasa, arif dan berwibawa, sehingga menjadi teladan bagi peserta didik, mandiri dan bertanggung jawab terhadap perkembangan profesinya, anak didiknya, lingkungan kerjanya, masyarakat dan bangsanya.</p>\r\n\r\n<p><strong>Profesional</strong></p>\r\n\r\n<p>Lulusan dapat menguasai :</p>\r\n\r\n<p>Mampu menyelenggarakan (merencanakan, mengolah dan menyajikan) makanan continental,</p>\r\n\r\n<p>Mampu mengembangkan inovasi pengolahan dan pengawetan pangan,</p>\r\n\r\n<p>Mampu mendesain dan menata hidangan untuk buku dan iklan di berbagai media dengan kemampuan kulineri yang dimiliki,</p>\r\n\r\n<p>Mampu mendemonstrasikan berbagai jenis makanan di berbagai tempat,</p>\r\n\r\n<p>Mampu menulis artikel bidang boga pada media cetak,</p>\r\n\r\n<p>Mampu mengelola restoran, katering, dan toko kue/roti,</p>\r\n\r\n<p>Mampu memimpin organisasi pada bidang pelayanan makanan dan minuman di hotel,</p>\r\n\r\n<p>Mampu menerapkan SSOP (Standard Sanitation Operating Procedures) pada bidang usaha boga dan industri pangan dan&nbsp;</p>\r\n\r\n<p>Mampu membuka lapangan kerja bidang boga.</p>\r\n\r\n<p><br />\r\n<strong>Sosial</strong></p>\r\n\r\n<p>Lulusan memiliki kemampuan untuk berkomunikasi secara efektif dengan peserta didik, tenaga kependidikan, orang tua/ wali dan masyarakat</p>\r\n', '5.jpg', 'Diploma III'),
...
CREATE TABLE `slider` (
  ...
  `foto_slider` varchar(250) DEFAULT NULL,
  `judul_slider` varchar(500) DEFAULT NULL,
  `deskripsi_slider` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `slider` (`id_slider`, `foto_slider`, `judul_slider`, `deskripsi_slider`) VALUES
(5, '5.jpg', 'Kegiatan 1', 'Kegiatan');
...
INSERT INTO `tour_kampus` (`id_tour`, `judul_tour`, `deskripsi_tour`, `foto_tour`) VALUES
(1, 'Gerbang Kampus', '<p>Tour di mulai dari gerbang kampus nan asri, berlokasi di jantung kota Jakarta, kawasan bisnis SCBD, Jl. Jend. Sudirman Jakarta.</p>', '1.jpg'),
(2, 'Gedung Kampus', '<p>Gedung berlantai 3 dengan 20 kelas belajar, 6 praktek laboratorium, sarana olahraga, parkiran yang luas siap menanti anda.</p>', '2.jpg'),
(3, 'Ruang Kelas', '<p>Ruang kelas ber AC, memilki Projector dan luas akan menjadi sarana pembelajaran harian anda.</p>', '3.jpg'),
(4, 'Pembelajaran Outdoor', '<p>Namun, pembelajaran out-door yang menyenangkan pun menjadi hal yang rutin di kampus JIHS</p>', '4.jpg'),
(5, 'Perpustakaan', '<p>Tentunya, perpustakaan yang unik dan menyenangkan akan mendukung pembelajaran dan referensi anda.</p>', '5.jpg'),
(6, 'Laboratorium Komputer', '<p>Bahkan, lab komputer yang menampung 40 mahasiswa akan selalu tersedia untuk anda.</p>', '6.jpg'),
(7, 'Musholla', '<p>Musholla yang bersih juga di siapkan</p>', '7.jpg'),
(8, 'Ibadah', '<p>Jangan lupa beribadah ya &hellip;.</p>', '8.jpg'),
(9, 'Ruang Praktek House Keeping dan FO', '<p>Sekarang kita menjelajah ke ruang praktek House keeping dan FO, sebuah kamar yang cantik siap menanti anda untuk praktek house keeping</p>', '9.jpg'),
(10, 'House Keeping dan FO - Rest Room', '<p>Kamar yang dilengkapi rest room yang modern pastinya.</p>', '10.jpg'),
(11, 'Praktek Laundry', '<p>Eittssss, praktek laundry pun tetap menyenangkan untuk dilaksanakan.</p>', '11.jpg'),
(12, 'Lobby Hotel Mini', '<p>Lobby hotel mini kami siapkan untuk praktek GRO dan Public Relation.</p>', '12.jpg'),
(13, 'Hotel Reservation', '<p>Check-in, check-out, reservation process akan lebih mudah dilakukan di ruang praktek ini.</p>', '13.jpg'),
(14, 'Praktek Restaurant', '<p>JIHS memiliki restauran praktek dengan kapasitas 30 dining seat loh.</p>	', '14.jpg'),
(15, 'Restaurant Bar', '<p>Restauran ini dilengkapi dengan bar dan berbagai minuman, baik cocktail maupun mocktail.</p>', '15.jpg'),
(16, 'Perlengkapan FB', '<p>Perlengkapan FB yang sangat lengkap tersimpan rapi di <em>store</em> kami.</p>', '16.jpg'),
(17, 'Kitchen JIHS', '<p>Di mana semua makanan restauran di masak? Pastinya di <em>Kitchen</em> JIHS yang nyaman dan lengkap.</p>', '17.jpg'),
(18, 'Mari Bergabung', '<p>Kampus dan nyaman dengan suasana kekeluargaan siap menunggu anda semua, mari bergabung dan sukses bersama kami.</p>', '18.JPG');
...
ALTER TABLE `calon_mahasiswa`
  ADD PRIMARY KEY (`id_calonmahasiswa`);
...
--
ALTER TABLE `calon_mahasiswa`
  MODIFY `id_calonmahasiswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `log_activity`
  MODIFY `nolog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=604;
--
